...
<style>
    ...
    .dc-map-shell { background:#fff; border:1px solid var(--dc-border, #e2e8f0); border-radius:0; overflow:hidden; }
    ...
    .dc-map-popup-badge { display:inline-block; margin:.35rem .25rem .35rem 0; padding:.15rem .45rem; border-radius:0; background:var(--dc-canvas, #f8fafc); border:1px solid var(--dc-border, #e2e8f0); color:var(--dc-ink, #1d2939); font-size:.75rem; font-weight:700; }
    .dc-map-popup-action { display:inline-block; margin-top:.45rem; padding:.35rem .55rem; border-radius:0; background:var(--dc-scouts-purple, #7413dc); color:#fff !important; text-decoration:none; font-weight:700; font-size:.85rem; }
    .dc-map-list { display:grid; gap:.5rem; margin-top:1rem; }
    .dc-map-list-item { background:#fff; border:1px solid var(--dc-border, #e2e8f0); border-radius:0; padding:.8rem; display:grid; gap:.5rem; }
    ...
    .dc-map-list-button { display:inline-flex; align-items:center; justify-content:center; min-height:36px; padding:.35rem .65rem; border-radius:0; background:var(--dc-scouts-purple, #7413dc); color:#fff; text-decoration:none; font-weight:700; font-size:0.85rem; border:0; cursor:pointer; }
</style>
