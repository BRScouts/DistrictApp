...
$memberships = function_exists('gm_current_memberships') ? gm_current_memberships($user) : [];
$isDistrictAdmin = function_exists('gm_actor_is_district_admin') ? gm_actor_is_district_admin($user, $memberships) : false;
...
if (!$isDistrictAdmin) {
    ...
    $heroText = '';
    $breadcrumb = '<a href="/index.php">Home</a> / Permissions';
    include __DIR__ . '/header.php';
    echo '<main class="lt-main"><div class="alert alert-danger">This page is only available to District Administrators.</div></main>';
    include __DIR__ . '/footer.php';
    exit;
}

$pageTitle = 'Permissions Reference | ' . $appName;
$heroTitle = 'Permissions Reference';
$heroText = 'How access and roles work across the Leader Tool.';
$breadcrumb = '<a href="/index.php">Home</a> / <a href="/district-admin.php">District Admin</a> / Permissions';
        ...
        <table class="perm-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>Full access to everything including system settings and all groups.</td>
                </tr>
                <tr>
                    <td><span class="perm-badge perm-badge-admin">District Admin</span></td>
                    <td>District leadership (DLV, DC team)</td>
                    <td>
                        Manage all groups, all people, set primary roles, access the District Admin panel, view all calendar events, approve/reject events, manage district settings.
                    </td>
                </tr>
                <tr>
